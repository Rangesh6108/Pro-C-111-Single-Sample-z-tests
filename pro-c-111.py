...
readfile=pd.read_csv('sample_2.csv')
data=readfile['reading_time'].tolist()
...
# Finding the mean of the students who used app and plotting it on the plot.
...
fig.add_trace(go.Scatter(x=[mean_of_sample2, mean_of_sample2], y=[0, 1.4], mode="lines", name="Mean of the students who used app"))
